...
Each LDR forms a voltage divider with a fixed 10K resistor. The LDR connects from the ADC pin to VCC, and the 10K resistor connects from the ADC pin to ground. In bright light, the LDR resistance drops (to around 1K or less), and the voltage at the ADC pin rises toward VCC. In darkness, the LDR resistance increases (to hundreds of kilohms), and the voltage drops toward ground.
