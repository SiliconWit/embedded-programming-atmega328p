...
heroImage: "https://cdn.siliconwit.com/education/embedded-programming-atmega328p/uart-serial-communication.png"
---
...
<PodcastEmbed src="https://open.spotify.com/episode/6TfVbjBI7HmBa0TZ0xaPAc?si=3_WlbDveT56-KqJrNnF-jQ" />
...
The complete firmware later in this lesson uses blocking TX for simplicity. The ring buffer technique shown here is a common optimization you can apply when your main loop cannot afford to wait for each byte to finish sending.
...
![Arduino Nano with NTC thermistor voltage divider wired to ADC0 for UART temperature logger](https://cdn.siliconwit.com/education/embedded-programming-atmega328p/Nano-Thermistor-UART.png)
...
The voltage at the ADC pin is determined by the voltage divider: V_adc = VCC * R_fixed / (R_therm + R_fixed). Since the 10-bit ADC maps 0 to VCC across 0 to 1023, the ADC reading is adc = 1023 * R_fixed / (R_therm + R_fixed). Solving for R_therm:
